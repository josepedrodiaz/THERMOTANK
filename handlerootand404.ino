...
void handleRoot() {
  ...
  String uptime = getUptime();
   ...
   message += "<p><br />Segundos que estara encendido el rele <form method='get' action='setTimeout'><input name='segundosON' value='";
   ...
   message += uptime;
   message += "<br /><br /> Se apagara en";
   message += (segundosON - millis())/1000;
   message += "segundos";
   message += "<p><a href='https://www.google.com.ar/search?q=";
   message += (segundosON - millis())/1000;
   message += "+segundos+a+horas'>En horas</a>";
   message += "- <a href='https://www.google.com.ar/search?q=";
   message += (segundosON - millis())/1000;
   message += "+segundos+a+minutos'>En minutos</a></p>";
